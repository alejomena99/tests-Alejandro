...
stg_account_key=$(echo todo bn)

echo "##vso[task.setvariable variable=mySecretVal;issecret=true]$stg_account_key"
echo "##vso[task.setvariable variable=myVal]$stg_account_key"
